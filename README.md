...
Por favor lee el [CONTRIBUTING.md](https://github.com/adrianfrancofAdministracionBodega.git) para detalles de código de conducta, y el proceso para enviar pull requests.
